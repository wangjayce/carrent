			...
			<div class="layui-main mag0">
			    ...
			    <ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" id="userInfo">
						<a href="javascript:;"><img src="${user.imgpath }" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">${user.name }</cite></a>
	...
	<script type="text/javascript">
        ...
        layui.use(['bodyTab','form','element','layer','jquery'],function(){
            ...
            tab = layui.bodyTab({
                ...
                url : "${ctx}/login/loadIndexTree.action" //获取菜单json地址
            });
        ...
        //图片管理弹窗
        function showImg(){
            $.getJSON('${ctx}/resources/json/images.json', function(json){
                var res = json;
                layer.photos({
                    photos: res,
                    anim: 5
