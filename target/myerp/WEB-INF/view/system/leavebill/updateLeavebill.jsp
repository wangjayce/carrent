	...
	<form class="layui-form" method="post" id="frm">
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="title" lay-verify="title" autocomplete="off"
					placeholder="请输入请假标题" value="${leavebill.title }" class="layui-input">
		...
		<div class="layui-form-item">
			...
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="leavetime"   id="leavetime" value="<fmt:formatDate value="${leavebill.leavetime }" pattern="yyyy-MM-dd"/>"  autocomplete="off"
						class="layui-input">
				</div>
			</div>
		</div>
	  ...
	  <div class="layui-form-item" style="text-align: center;">
	      <button class="layui-btn" lay-submit="" lay-filter="updateLeavebill">提交</button>
