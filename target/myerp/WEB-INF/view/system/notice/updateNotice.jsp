	...
	<form class="layui-form" action="#" method="get" id="frm" lay-filter="frm">
		...
		<div class="layui-form-item" style="margin-top: 10px">
			...
			<div class="layui-input-block" style="width: 80%">
				<input type="text" name="title" id="title" value="${notice.title }" lay-verify="required" autocomplete="off"
					class="layui-input">
		...
		<div class="layui-form-item layui-form-text">
			...
			<textarea id="notice" name="content" style="width: 80%;height: 300px">${notice.content }</textarea>
		</div>		
...
<script type="text/javascript">
	layui.use([ 'form','jquery','layer','layedit'], function() {
		...
		form.on("submit(noticeSubmit)",function(data){
			...
			var title = $('#title').val();
			var id = $('#id').val();
			$.post('${ctx}/notice/updateNotice.action?id='+id+"&title="+title+"&content="+content,function(data){
				layer.msg(data.msg);
