	...
	<form class="layui-form" action="#" method="get" id="frm" lay-filter="frm">
		...
		<div class="layui-form-item" style="margin-top: 10px">
				...
				<div class="layui-input-inline" >
						<input type="text" name="providername" id="providername" lay-verify="required" autocomplete="off"
							class="layui-input">
	   			</div>
...
<script type="text/javascript">
	layui.use([ 'form','jquery','layer' ], function() {
		...
		form.on("submit(providerSubmit)",function(data){
		    ...
		    $.post('${ctx}/provider/addProvider.action',params,function(data){
				layer.msg(data.msg);
