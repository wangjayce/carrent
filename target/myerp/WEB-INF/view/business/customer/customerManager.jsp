    ...
    layui.use(['form','layer','table','laytpl'],function(){
	  	  var form = layui.form,
			    ...
			    tableIns = table.render({
			        elem: '#customerList',
			        url : '${ctx}/customer/uploadAllCustomer.action',
			        cellMinWidth : 95,
			        page : true,
			        height : "full-225",
			        limit : 10,
			        ...
			        cols : [[
			            ...
			            {field: 'id', title: '客户ID', width:160, align:"center"},
			            ...
			            {field: 'fax', title: '客户传真',width:150, align:'center'},
	                	...
	                	var ids="?a=1";
	                	 if(data.length > 0) {
	 	                    ...
	 	                    layer.confirm('确定删除选中的客户？', {icon: 3, title: '提示信息'}, function (index) {
	 	                         $.post("${ctx}/customer/deleteCustomer.action"+ids,function(data){
	 	                        	layer.msg(data.msg);
	 	                        	tableIns.reload();
	 	                        	layer.close(index);
	 	                         })
        ...
        function addCustomer(){
        	layer.open({
        		  type: 2, 
        		  title:'发布客户',
        		  content: '${ctx}/customer/toaddCustomer.action', //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
        		  area : ['800px','600px']
          	}); 
        }
        function updateCustomer(id){
        	layer.open({
        		  type: 2, 
        		  title:'修改客户',
        		  content: '${ctx}/customer/toupdateCustomer.action?id='+id, //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']
        		  area : ['800px','600px']
          	}); 
        }
