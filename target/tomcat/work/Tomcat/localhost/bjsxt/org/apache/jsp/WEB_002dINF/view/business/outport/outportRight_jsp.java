 ...
 * Generated at: 2018-09-20 04:04:51 UTC
...
public final class outportRight_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t  </div>\r\n");
      out.write("\t</form>\r\n");
      out.write("\t<table id=\"outportList\" lay-filter=\"outportList\"></table>\r\n");
      out.write("\t\r\n");
      out.write("\r\n");
      out.write("\t<!--操作-->\r\n");
      out.write("\t<script type=\"text/html\" id=\"outportListBar\">\r\n");
      ...
      out.write("\t        elem: '#outportList',\r\n");
      out.write("\t        url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/outport/uploadAllOutport.action',\r\n");
      ...
      out.write("\t        id : \"outportList\",\r\n");
      out.write("\t        cols : [[\r\n");
      out.write("\t            {type: \"checkbox\", fixed:\"left\", width:50},\r\n");
      out.write("\t            {field: 'id', title: '退货单ID', width:100, align:\"center\"},\r\n");
      ...
      out.write("\t            {field: 'outportprice', title: '退货价格', align:'center'},\r\n");
      out.write("\t            {field: 'outporttime', title: '退货时间', width:140, align:\"center\"},\r\n");
      out.write("\t            {field: 'operateperson', title: '操作人',width:100, align:'center'},\r\n");
      out.write("\t            {field: 'number', title: '退货数量', align:'center'},\r\n");
      out.write("\t            {field: 'remark', title: '备注', align:'center'},\r\n");
      out.write("\t            {title: '操作', width:170, templet:'#outportListBar',fixed:\"right\",align:\"center\"}\r\n");
      out.write("\t        ]]\r\n");
      out.write("\t    });\r\n");
      out.write("\t\r\n");
      out.write("        //监听头工具栏事件\r\n");
      out.write("        table.on('toolbar(outportList)', function(obj){\r\n");
      ...
      out.write(" \t                    }\r\n");
      out.write(" \t                    layer.confirm('确定删除选中的退货单？', {icon: 3, title: '提示信息'}, function (index) {\r\n");
      out.write(" \t                         $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/outport/deleteOutport.action\"+ids,function(data){\r\n");
      ...
      out.write(" \t                    })\r\n");
      out.write(" \t                }else{\r\n");
      out.write(" \t                    layer.msg(\"请选择需要删除的退货单\");\r\n");
      out.write(" \t                }\r\n");
      out.write("                    break;\r\n");
      out.write("                case 'add':\r\n");
      out.write("                \taddOutport();\r\n");
      out.write("                \tbreak;\r\n");
      out.write("            };\r\n");
      out.write("        });\r\n");
      out.write("        function addOutport(){\r\n");
      out.write("        \tlayer.open({\r\n");
      out.write("      \t\t  type: 2, \r\n");
      out.write("      \t\t  title:'添加退货单',\r\n");
      out.write("      \t\t  content: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/outport/toaddOutport.action', //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']\r\n");
      out.write("      \t\t  area : ['800px','600px']\r\n");
      out.write("        \t}); \r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function updateOutport(id){\r\n");
      out.write("        \tlayer.open({\r\n");
      out.write("      \t\t  type: 2, \r\n");
      out.write("      \t\t  title:'修改退货单',\r\n");
      out.write("      \t\t  content: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/outport/toupdateOutport.action?id='+id, //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']\r\n");
      out.write("      \t\t  area : ['800px','600px']\r\n");
      out.write("        \t}); \r\n");
      out.write("        }\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t  \r\n");
      out.write("\t    //列表操作\r\n");
      out.write("\t    table.on('tool(outportList)', function(obj){\r\n");
      out.write("\t        var layEvent = obj.event,\r\n");
      out.write("\t            data = obj.data;\r\n");
      out.write("\t        if(layEvent === 'update'){\r\n");
      out.write("\t        \tupdateOutport(data.id);\r\n");
      out.write("\t        }\r\n");
      out.write("\t\t\tif(layEvent === 'del'){ //删除\r\n");
      out.write("\t            layer.confirm('确定删除此退货单？',{icon:3, title:'提示信息'},function(index){\r\n");
      out.write("\t                $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/outport/deleteOutport.action\",{\r\n");
