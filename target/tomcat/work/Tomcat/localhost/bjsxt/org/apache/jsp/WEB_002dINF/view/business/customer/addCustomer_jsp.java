 ...
 * Generated at: 2018-09-16 08:02:53 UTC
...
public final class addCustomer_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>供应商管理--新增供应商</title>\r\n");
      ...
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"customername\" id=\"customername\" lay-verify=\"required\" autocomplete=\"off\"\r\n");
      out.write("\t\t\t\t\t\t\tclass=\"layui-input\">\r\n");
      out.write("\t   \t\t\t</div>\r\n");
      out.write("\t\t\t\t<label class=\"layui-form-label\">公司电话</label>\r\n");
      out.write("\t\t\t\t<div class=\"layui-input-inline\" >\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"telephone\" id=\"telephone\" lay-verify=\"number\" autocomplete=\"off\"\r\n");
      out.write("\t\t\t\t\t\tclass=\"layui-input\">\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<div class=\"layui-input-inline\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"zip\" id=\"zip\" lay-verify=\"number\" autocomplete=\"off\"\r\n");
      out.write("\t\t\t\t\tclass=\"layui-input\">\r\n");
      out.write("\t\t \t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"layui-form-item\">\r\n");
      ...
      out.write("\t\t\t\t<input type=\"text\" name=\"address\" id=\"address\" lay-verify=\"required\" autocomplete=\"off\"\r\n");
      out.write("\t\t\t\t\tclass=\"layui-input\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"layui-form-item\" style=\"margin-top: 10px\">\r\n");
      ...
      out.write("\t\t\t<div class=\"layui-input-inline\" >\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"connectionperson\" id=\"connectionperson\" lay-verify=\"required\" autocomplete=\"off\"\r\n");
      out.write("\t\t\t\t\tclass=\"layui-input\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<label class=\"layui-form-label\">联系人电话</label>\r\n");
      out.write("\t\t\t<div class=\"layui-input-inline\" >\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"phone\" id=\"phone\" lay-verify=\"number\" autocomplete=\"off\"\r\n");
      out.write("\t\t\t\t\tclass=\"layui-input\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"layui-form-item\">\r\n");
      ...
      out.write("\t\t\t\t<div class=\"layui-input-inline\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"email\" id=\"email\" lay-verify=\"email\" autocomplete=\"off\"\r\n");
      out.write("\t\t\t\t\tclass=\"layui-input\">\r\n");
      out.write("\t\t \t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\t\t<div class=\"layui-input-inline\" >\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"bank\" id=\"bank\" lay-verify=\"required\" autocomplete=\"off\"\r\n");
      out.write("\t\t\t\t\tclass=\"layui-input\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<label class=\"layui-form-label\">银行账号</label>\r\n");
      out.write("\t\t\t<div class=\"layui-input-inline\" >\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"account\" id=\"account\" lay-verify=\"number\" autocomplete=\"off\"\r\n");
      out.write("\t\t\t\t\tclass=\"layui-input\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"layui-form-item\">\r\n");
      ...
      out.write("\t\t\t<div class=\"layui-input-inline\" >\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"fax\" id=\"fax\" lay-verify=\"number\" autocomplete=\"off\"\r\n");
      out.write("\t\t\t\t\tclass=\"layui-input\">\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div class=\"layui-form-item\">\r\n");
      ...
      out.write("\t\t\t\t<a class=\"layui-btn\" lay-submit=\"\" lay-filter=\"customerSubmit\">提交</a>\r\n");
      ...
      out.write("\t\t\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tform.on(\"submit(customerSubmit)\",function(data){\r\n");
      out.write("\t\t\tvar params = $('#frm').serialize();\r\n");
      out.write("\t\t    $.post('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/customer/addCustomer.action',params,function(data){\r\n");
      out.write("\t\t\t\tlayer.msg(data.msg);\r\n");
      out.write("\t\t\t\tvar index = layer.getFrameIndex(window.name);\r\n");
      out.write("\t\t\t\tlayer.close(index);\r\n");
      out.write("\t\t\t\twindow.parent.datareload();\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t});\t\t\t  \r\n");
      out.write("\t});\r\n");
