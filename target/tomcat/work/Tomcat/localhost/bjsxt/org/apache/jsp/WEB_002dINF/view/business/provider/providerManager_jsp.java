 ...
 * Generated at: 2018-09-16 07:58:12 UTC
...
public final class providerManager_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t    </div>\r\n");
      out.write("\t\t\t    <div class=\"layui-inline\">\r\n");
      out.write("\t\t\t\t      <label class=\"layui-form-label\">供应商电话</label>\r\n");
      out.write("\t\t\t\t      <div class=\"layui-input-inline\">\r\n");
      ...
      out.write("\t\t\t\t      <div class=\"layui-input-inline\">\r\n");
      out.write("\t\t\t\t        <input type=\"tel\" name=\"connectionperson\" id=\"connectionperson\" autocomplete=\"off\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t      </div>\r\n");
      out.write("\t\t\t    </div>\r\n");
      out.write("\t\t  </div>\t    \r\n");
      ...
      out.write("\t\t\t        url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/provider/uploadAllProvider.action',\r\n");
      ...
      out.write("\t\t\t        id : \"providerList\",\r\n");
      out.write("\t\t\t        cols : [[\r\n");
      out.write("\t\t\t            {type: \"checkbox\", fixed:\"left\", width:50},\r\n");
      out.write("\t\t\t            {field: 'id', title: '供应商ID', width:160, align:\"center\"},\r\n");
      out.write("\t\t\t            {field: 'providername', title: '供应商名称',width:180, align:\"center\"},\r\n");
      out.write("\t\t\t            {field: 'telephone', title: '公司电话',width:180, align:\"center\"},\r\n");
      out.write("\t\t\t            {field: 'phone', title: '联系人手机',width:200, align:\"center\"},\r\n");
      out.write("\t\t\t            {field: 'connectionperson', title: '联系人', align:'center'},\r\n");
      out.write("\t\t\t            {field: 'address', title: '地址', align:'center'},\r\n");
      out.write("\t\t\t            {field: 'zip', title: '邮编', align:'center'},\r\n");
      out.write("\t\t\t            {field: 'bank', title: '开户银行', align:'center'},\r\n");
      out.write("\t\t\t            {field: 'account', title: '银行卡号',width:200, align:'center'},\r\n");
      out.write("\t\t\t            {field: 'email', title: '邮箱',width:150, align:'center'},\r\n");
      out.write("\t\t\t            {field: 'fax', title: '供应商传真',width:150, align:'center'},\r\n");
      out.write("\t\t\t            {field: 'available', title: '可否有效', align:'center',templet:function(data){\r\n");
      out.write("\t\t\t            \treturn data.available==\"1\"?\"<font color=blue>可用</font>\":\"<font color=red>不可用</font>\"\r\n");
      out.write("\t\t\t            }},\r\n");
      out.write("\t\t\t            {title: '操作', width:170, templet:'#providerListBar',fixed:\"right\",align:\"center\"}\r\n");
      out.write("\t\t\t        ]]\r\n");
      out.write("\t\t\t    });\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t        //监听头工具栏事件\r\n");
      ...
      out.write("\t \t                         $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/provider/deleteProvider.action\"+ids,function(data){\r\n");
      ...
      out.write("\t    });\r\n");
      out.write("\t    \r\n");
      out.write("        function addProvider(){\r\n");
      out.write("        \tlayer.open({\r\n");
      out.write("        \t\t  type: 2, \r\n");
      out.write("        \t\t  title:'发布供应商',\r\n");
      out.write("        \t\t  content: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/provider/toaddProvider.action', //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']\r\n");
      out.write("        \t\t  area : ['1200px','600px']\r\n");
      out.write("          \t}); \r\n");
      out.write("        }\r\n");
      out.write("        function updateProvider(id){\r\n");
      out.write("        \tlayer.open({\r\n");
      out.write("        \t\t  type: 2, \r\n");
      out.write("        \t\t  title:'修改供应商',\r\n");
      out.write("        \t\t  content: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/provider/toupdateProvider.action?id='+id, //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']\r\n");
      out.write("        \t\t  area : ['1200px','600px']\r\n");
      out.write("          \t}); \r\n");
      out.write("        }\r\n");
      out.write(" \r\n");
      ...
      out.write("\t            layer.confirm('确定删除此供应商？',{icon:3, title:'提示信息'},function(index){\r\n");
      out.write("\t                $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/provider/deleteProvider.action\",{\r\n");
      ...
      out.write("\t\t\t\tupdateProvider(data.id);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t    });\r\n");
      out.write("\t\r\n");
      out.write("\t })\r\n");
