 ...
 * Generated at: 2018-09-14 06:22:15 UTC
...
public final class permissionRight_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t      <div class=\"layui-input-inline\">\r\n");
      out.write("\t\t\t\t        <input type=\"text\" name=\"percode\" id=\"percode\" autocomplete=\"off\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t      </div>\r\n");
      out.write("\t\t\t    </div>\t\r\n");
      out.write("\t\t  </div>\r\n");
      out.write("\t\t  <div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t     <div class=\"layui-inline\" style=\"text-align: center;\">\r\n");
      ...
      out.write("\t\t\t</div>\t\r\n");
      out.write("\t</form>\r\n");
      out.write("\t<table id=\"permissionList\" lay-filter=\"permissionList\"></table>\r\n");
      out.write("\t\r\n");
      out.write("\r\n");
      out.write("\t<!--操作-->\r\n");
      out.write("\t<script type=\"text/html\" id=\"permissionListBar\">\r\n");
      ...
      out.write("\t        elem: '#permissionList',\r\n");
      out.write("\t        url : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/permission/uploadAllPermission.action',\r\n");
      ...
      out.write("\t        id : \"permissionList\",\r\n");
      out.write("\t        cols : [[\r\n");
      out.write("\t            {type: \"checkbox\", fixed:\"left\", width:50},\r\n");
      out.write("\t            {field: 'id', title: '权限ID', width:150, align:\"center\"},\r\n");
      out.write("\t            {field: 'pid', title: '上级权限ID', width:150, align:\"center\"},\r\n");
      out.write("\t            {field: 'name', title: '权限名称', width:150,align:'center'},\r\n");
      out.write("\t            {field: 'ordernum', title: '排序码', align:'center'},\r\n");
      out.write("\t            {field: 'percode', title: '权限code', align:'center'},\r\n");
      ...
      out.write("\t            }},\t      \r\n");
      out.write("\t            {title: '操作', width:170, templet:'#permissionListBar',fixed:\"right\",align:\"center\"}\r\n");
      out.write("\t        ]]\r\n");
      out.write("\t    });\r\n");
      out.write("\t\r\n");
      out.write("        //监听头工具栏事件\r\n");
      out.write("        table.on('toolbar(permissionList)', function(obj){\r\n");
      out.write("        \t\r\n");
      ...
      out.write(" \t                    }\r\n");
      out.write(" \t                    layer.confirm('确定删除选中的权限？', {icon: 3, title: '提示信息'}, function (index) {\r\n");
      out.write(" \t                         $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/permission/deletePermission.action\"+ids,function(data){\r\n");
      ...
      out.write(" \t                    })\r\n");
      out.write(" \t                }else{\r\n");
      out.write(" \t                    layer.msg(\"请选择需要删除的权限\");\r\n");
      out.write(" \t                }\r\n");
      out.write("                    break;\r\n");
      out.write("                case 'add':\r\n");
      ...
      out.write("      \t\t  content: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/permission/toaddPermission.action', //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']\r\n");
      out.write("      \t\t  area : ['800px','600px']\r\n");
      out.write("        \t}); \r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
      out.write("        function updatePermission(id){\r\n");
      out.write("        \tlayer.open({\r\n");
      out.write("      \t\t  type: 2, \r\n");
      out.write("      \t\t  title:'修改权限',\r\n");
      out.write("      \t\t  content: '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/permission/toupdatePermission.action?id='+id, //这里content是一个URL，如果你不想让iframe出现滚动条，你还可以content: ['http://sentsin.com', 'no']\r\n");
      out.write("      \t\t  area : ['800px','600px']\r\n");
      out.write("        \t}); \r\n");
      out.write("        }\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t  \r\n");
      out.write("\t    //列表操作\r\n");
      out.write("\t    table.on('tool(permissionList)', function(obj){\r\n");
      out.write("\t        var layEvent = obj.event,\r\n");
      out.write("\t            data = obj.data;\r\n");
      out.write("\t        if(layEvent === 'update'){\r\n");
      out.write("\t        \tupdatePermission(data.id);\r\n");
      out.write("\t        }\r\n");
      out.write("\t\t\tif(layEvent === 'del'){ //删除\r\n");
      out.write("\t            layer.confirm('确定删除此权限？',{icon:3, title:'提示信息'},function(index){\r\n");
      out.write("\t                $.post(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/permission/deletePermission.action\",{\r\n");
