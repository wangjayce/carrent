 ...
 * Generated at: 2018-09-14 01:35:52 UTC
...
public final class addNotice_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<input type=\"text\" name=\"title\" id=\"title\" lay-verify=\"required\" autocomplete=\"off\"\r\n");
      ...
      out.write("\t\t\t<textarea id=\"notice\" name=\"content\" ></textarea>\r\n");
      out.write("\t\t</div>\t\t\r\n");
      out.write("\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t<div class=\"layui-input-block\" style=\"text-align: center;\">\r\n");
      out.write("\t\t\t\t<!--lay-submit标记当按钮是一个提交按钮   -->\r\n");
      out.write("\t\t\t\t<a class=\"layui-btn\" lay-submit=\"\" lay-filter=\"noticeSubmit\">提交</a>\r\n");
      ...
      out.write("\t\t\tvar content = layedit.getContent(editIndex);\r\n");
      out.write("\t\t\tvar title = $('#title').val();\r\n");
      out.write("\t\t    $.post('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/notice/addNotice.action',{title:title,content:content},function(data){\r\n");
      out.write("\t\t\t\tlayer.msg(data.msg);\r\n");
      out.write("\t\t\t\tvar index = layer.getFrameIndex(window.name);\r\n");
      out.write("\t\t\t\tlayer.close(index);\r\n");
      out.write("\t\t\t\talert(window.parent.location);\r\n");
